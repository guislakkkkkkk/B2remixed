--colors
phillyLightsColors = {'0xFF0000', '0xFF31FD8C', '0xFFFB33F5', '0xFFFD4531', '0xFFFBA633'}
...
bgTransparency = 0.8 --how transparent the black bg will be
	...
	if tag == 'Philly Glow Recreation' then
		...
		if lightId == 0 then
			...
			if active then
				...
				cameraFlash('camGame', 'FFFFFF', 0.05)
